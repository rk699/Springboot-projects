package com.purusottam.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "com.purusottam";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/regionalfood-model"),
        mapper("/regionalfood-dao"),
        mapperxml("/regionalfood-web"),
        service("/regionalfood-service"),
        web("/regionalfood-web"),
        ;
